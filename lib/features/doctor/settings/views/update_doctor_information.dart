...
class UpdateDoctorInformations extends StatefulWidget {
  const UpdateDoctorInformations({super.key});

  @override
  State<UpdateDoctorInformations> createState() =>
      _UpdateDoctorInformationsState();
}

class _UpdateDoctorInformationsState extends State<UpdateDoctorInformations> {
  User? user;
                                            ...
                                            validator: (value) {
                                              if (value!.isEmpty) {
                                                return "من فضلك ادخل ${labelName[index]}";
                                                  ...
                                                  labelvalue[index] =="phone1" ||  labelvalue[index] =="phone2" ) {
